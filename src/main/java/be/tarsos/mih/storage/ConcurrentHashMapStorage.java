...
/**
 * Implements storage using the safe hash map implementation of the java runtime.
 *  
 * @author Joren Six
 *
 */
public class ConcurrentHashMapStorage implements MIHStorage {

	private final List<ConcurrentHashMap<Integer, long[]>> hashtables;

	public ConcurrentHashMapStorage(int numberOfTables){
